...
public class _06_Maps_Methods {
    public static void main(String[] args) {
      //   HashMap<KEY, VALUE> name = new HashMap<>();
        ...
        capitals.put("France", "Paris"); // {France=Paris}
        ...
        System.out.println(capitals.getOrDefault("Belgium", "Does not exists!")); // Does not exists!
        ...
        System.out.println(capitals.put("Turkey", "Istanbul"));
        ...
        TreeSet<String> treeSet  = new TreeSet<>(capitals.keySet()); // [Italy, Spain, Turkey]
