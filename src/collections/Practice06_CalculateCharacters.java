...
public class Practice06_CalculateCharacters {
    public static void main(String[] args) {
       ...
       // System.out.println(map); // {b=1, a=3, n=2}
        ...
        /*
        Check the entry
        If the entry value is > 1, then print key of entry
         */
    ...
    If there are more than one Character that is counted the most
    then return all
    If string is empty or null just return nothing
